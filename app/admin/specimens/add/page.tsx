...
export default function AddSpecimenPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || "Failed to create specimen")
      }
  ...
  return (
    <div className="max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Add New Specimen</h1>
          <p className="text-muted-foreground mt-2">Add a new specimen to the reference database</p>
        </div>
