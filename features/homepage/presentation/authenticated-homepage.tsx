...
// Mock data for recently added specimens (community-wide)
const recentCommunitySpecimens = [
  {
    id: "1",
    name: "Fluorite",
  ...
  },
  {
    id: "2",
    name: "Pyrite",
    locality: "Navajún, Spain",
    imageUrl: null,
    addedBy: "mineralcollector",
    addedAt: "5 hours ago"
  },
  {
    id: "3",
    name: "Amethyst",
    locality: "Thunder Bay, Canada",
    imageUrl: null,
    addedBy: "crystalseeker",
    addedAt: "8 hours ago"
  },
  {
    id: "4",
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {recentCommunitySpecimens.map((specimen) => (
                  <Card
                    key={specimen.id}
                    className="group overflow-hidden hover:border-primary/50 transition-all hover:shadow-lg cursor-pointer"
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between mt-3 pt-3 border-t border-border">
                        ...
                        <span className="text-xs text-muted-foreground">{specimen.addedAt}</span>
                      </div>
                    </div>
                  </Card>
                ))}
